...
function PureArtifact({
  ...
  const artifactPanel = (
    <>
      {sidebarState !== "collapsed" && (
        <div
          className="flex h-[var(--app-bar-height)] shrink-0 items-center justify-between border-b border-border px-4"
  ...
  return (
    <div
      className="flex h-dvh w-[60%] shrink-0 flex-col overflow-hidden bg-sidebar transition-[width] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
      data-testid="artifact"
    >
      {artifactPanel}
    </div>
